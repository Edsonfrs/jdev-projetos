...
public class Aluno {
	/* Por padrão todos os atributos no Java são private. Motivo: Boa prática. Controle de acesso aos atributos */
	private String nome;
	private int idade;
	...
	public Aluno() { /* Construtor padrão do Java. Cria os dados na memória*/
